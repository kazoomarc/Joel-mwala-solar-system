...
// Add this debug code to the Sphere::draw method or create a debug function:
void Sphere::debugSphere(Sphere &sphere)
{
    std::cout << "Sphere has " << sphere.getVertexCount() << " vertices" << std::endl;
    std::cout << "Sphere has " << sphere.getIndexCount() << " indices" << std::endl;

    // Print the first few vertices to verify they're not all zeros
